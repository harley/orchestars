...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "app_information_socials" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "app_information" DISABLE ROW LEVEL SECURITY;
  ...
  ALTER TABLE "payload_locked_documents_rels" DROP COLUMN IF EXISTS "app_information_id";`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD COLUMN "app_information_id" integer;
  DO $$ BEGIN
