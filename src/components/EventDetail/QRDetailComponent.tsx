    ...
    return (
        <div className="bg-white p-4 rounded-md shadow-md m-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="border p-4 rounded-md">
                    ...
                    <div className="flex justify-center mb-4">
                        ...
                        <VietQR amount={amount} addInfo={contentBankTransfer} onGenerate={(url) => setQrDataUrl(url)} />
                    </div>
                    {/* Example “Tải ảnh QR” button */}
                    <Button variant="outline" className="w-full" onClick={handleDownloadQR} disabled={!qrDataUrl}>
                        Tải ảnh QR
                    </Button>
                </div>
            ...
            <p className="text-sm text-gray-600 mt-4">
                Lưu ý: Vui lòng gửi hình ảnh giao dịch để xác nhận nhanh thanh toán của bạn
            </p>
